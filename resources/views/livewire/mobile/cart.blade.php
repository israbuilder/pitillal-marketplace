<div class="space-y-4">
    ...
    @empty
        <div class="rounded-3xl border border-dashed border-slate-300 p-10 text-center">
            ...
            <a href="{{ route('customer.home') }}" class="mt-4 inline-block rounded-xl bg-indigo-600 px-4 py-3 font-semibold text-white">Explorar productos</a>
        </div>
    @endforelse
    ...
    @if(count($items))
        ...
        <a href="{{ route('customer.checkout') }}" class="block w-full rounded-2xl bg-indigo-600 px-4 py-4 text-center font-bold text-white">Continuar</a>
    @endif
</div>
